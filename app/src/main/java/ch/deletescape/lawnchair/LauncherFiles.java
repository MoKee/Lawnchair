...
public class LauncherFiles {
    ...
    public static final String OLD_SHARED_PREFERENCES_KEY = "org.mokee.lawnchair.prefs";
    public static final String MANAGED_USER_PREFERENCES_KEY = "org.mokee.lawnchair.managedusers.prefs";
